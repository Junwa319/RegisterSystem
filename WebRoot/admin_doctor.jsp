...
<%      
    ...
    String sql1 = "select * from guahao  where doctor = ' 小李'" ;
	String sql2 = "select * from guahao  where doctor = ' 小周'" ;
	String sql3 = "select * from guahao  where doctor = ' 小赵'" ;
	String sql4 = "select * from guahao  where doctor = ' 小马'" ;
	String sql5 = "select * from guahao  where doctor = ' 小王'" ;
	String sql6 = "select * from guahao  where doctor = ' 小吴'" ;
	String sql7 = "select * from guahao  where doctor = ' 小谢'" ;
	String sql8 = "select * from guahao  where doctor = ' 小徐'" ;
  ...
  <div id="container">
    ...
    <%
            ...
            <br>
                <br>
        <table>
 	          <center><b>小吴的挂号情况</b></center>
    <%
        	while(res6.next()) 
        	  {%>
     
        		<tr>
        		        <td><%= res6.getString("id")%></td>
        				<td><%= res6.getString("user_name")%></td>
        				<td><%= res6.getString("sex")%></td>
        				<td><%= res6.getString("age")%></td>
        				<td><%= res6.getString("room")%></td>
        				<td><%= res6.getString("doctor")%></td>
        				<td><%= res6.getString("date")%></td>
        				<td><%= res6.getString("time")%></td>
            ...
            <br>
                <br>
        <table>
 	          <center><b>小谢的挂号情况</b></center>
    <%
        	while(res7.next()) 
        	  {%>
     
        		<tr>
        		        <td><%= res7.getString("id")%></td>
        				<td><%= res7.getString("user_name")%></td>
        				<td><%= res7.getString("sex")%></td>
        				<td><%= res7.getString("age")%></td>
        				<td><%= res7.getString("room")%></td>
        				<td><%= res7.getString("doctor")%></td>
        				<td><%= res7.getString("date")%></td>
        				<td><%= res7.getString("time")%></td>
            ...
            <br>
                <br>
        <table>
 	          <center><b>小徐的挂号情况</b></center>
    <%
        	while(res8.next()) 
        	  {%>
     
        		<tr>
        		        <td><%= res8.getString("id")%></td>
        				<td><%= res8.getString("user_name")%></td>
        				<td><%= res8.getString("sex")%></td>
        				<td><%= res8.getString("age")%></td>
        				<td><%= res8.getString("room")%></td>
        				<td><%= res8.getString("doctor")%></td>
        				<td><%= res8.getString("date")%></td>
        				<td><%= res8.getString("time")%></td>
